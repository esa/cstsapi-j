...
public class DataProcProcDataInvocExt implements BerType, Serializable {

	private static final long serialVersionUID = 1L;

	public static class ProcessCompletionReport implements BerType, Serializable {
		...
		public int encode(OutputStream reverseOS) throws IOException {
			...
			if (produceReport != null) {
				codeLength += produceReport.encode(reverseOS, false);
			...
			if (doNotProduceReport != null) {
				codeLength += doNotProduceReport.encode(reverseOS, false);
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += dataProcProcDataInvocExtExtension.encode(reverseOS);
		
		codeLength += processCompletionReport.encode(reverseOS);
