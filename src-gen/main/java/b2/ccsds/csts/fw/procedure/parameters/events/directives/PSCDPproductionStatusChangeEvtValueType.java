...
public class PSCDPproductionStatusChangeEvtValueType extends SvcProductionStatusVersion1Type {

	private static final long serialVersionUID = 1L;

	public PSCDPproductionStatusChangeEvtValueType() {
	}

	public PSCDPproductionStatusChangeEvtValueType(byte[] code) {
		super(code);
	}

	public PSCDPproductionStatusChangeEvtValueType(BigInteger value) {
		super(value);
	}

	public PSCDPproductionStatusChangeEvtValueType(long value) {
		super(value);
	}
