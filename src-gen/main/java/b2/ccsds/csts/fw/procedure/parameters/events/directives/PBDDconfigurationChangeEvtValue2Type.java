...
public class PBDDconfigurationChangeEvtValue2Type extends PBDDdeliveryLatencyLimitType {

	private static final long serialVersionUID = 1L;

	public PBDDconfigurationChangeEvtValue2Type() {
	}

	public PBDDconfigurationChangeEvtValue2Type(byte[] code) {
		super(code);
	}

	public PBDDconfigurationChangeEvtValue2Type(BigInteger value) {
		super(value);
	}

	public PBDDconfigurationChangeEvtValue2Type(long value) {
		super(value);
	}
