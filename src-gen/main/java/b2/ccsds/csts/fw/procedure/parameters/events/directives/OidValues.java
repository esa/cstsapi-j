...
public final class OidValues {
	...
	public static final BerObjectIdentifier pACinitiatorId = new BerObjectIdentifier(new int[]{1, 3, 112, 4, 4, 1, 1, 4, 1, 1, 1});
	public static final BerObjectIdentifier pACparametersId = new BerObjectIdentifier(new int[]{1, 3, 112, 4, 4, 1, 1, 4, 1, 1});
	public static final BerObjectIdentifier pACresponderId = new BerObjectIdentifier(new int[]{1, 3, 112, 4, 4, 1, 1, 4, 1, 1, 2});
	public static final BerObjectIdentifier pACresponderPortId = new BerObjectIdentifier(new int[]{1, 3, 112, 4, 4, 1, 1, 4, 1, 1, 3});
	public static final BerObjectIdentifier pACserviceInstanceId = new BerObjectIdentifier(new int[]{1, 3, 112, 4, 4, 1, 1, 4, 1, 1, 4});
	public static final BerObjectIdentifier pBDDconfigurationChange = new BerObjectIdentifier(new int[]{1, 3, 112, 4, 4, 1, 1, 4, 3, 2, 1});
