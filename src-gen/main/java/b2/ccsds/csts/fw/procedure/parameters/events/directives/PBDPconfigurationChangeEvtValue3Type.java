...
public class PBDPconfigurationChangeEvtValue3Type extends PBDPprocessingLatencyLimitType {
	...
	public PBDPconfigurationChangeEvtValue3Type() {
	}

	public PBDPconfigurationChangeEvtValue3Type(byte[] code) {
		super(code);
	}

	public PBDPconfigurationChangeEvtValue3Type(BigInteger value) {
		super(value);
	}

	public PBDPconfigurationChangeEvtValue3Type(long value) {
		super(value);
	}
