...
public class QualifiedValue implements BerType, Serializable {

	private static final long serialVersionUID = 1L;

	public byte[] code = null;
	private TypeAndValue valid = null;
	...
	public QualifiedValue(byte[] code) {
		this.code = code;
	}

	public void setValid(TypeAndValue valid) {
		this.valid = valid;
	}

	public TypeAndValue getValid() {
		return valid;
	}
	...
	public int encode(OutputStream reverseOS) throws IOException {
		...
		if (valid != null) {
			codeLength += valid.encode(reverseOS, false);
	...
	public int decode(InputStream is, BerTag berTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 0)) {
			valid = new TypeAndValue();
			codeLength += valid.decode(is, false);
			return codeLength;
		}
