...
public class ActionNotCompletedDiag implements BerType, Serializable {

	private static final long serialVersionUID = 1L;

	public byte[] code = null;
	public static class ParameterNames implements BerType, Serializable {
	...
	public int encode(OutputStream reverseOS) throws IOException {
		...
		if (noParameterNames != null) {
			codeLength += noParameterNames.encode(reverseOS, false);
		...
		if (parameterNames != null) {
			codeLength += parameterNames.encode(reverseOS, false);
