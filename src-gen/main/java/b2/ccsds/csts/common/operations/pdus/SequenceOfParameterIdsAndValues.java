...
public class SequenceOfParameterIdsAndValues implements BerType, Serializable {
	...
	public static class SEQUENCE implements BerType, Serializable {
		...
		private TypeAndValue parameterValue = null;
		...
		public void setParameterValue(TypeAndValue parameterValue) {
			this.parameterValue = parameterValue;
		}

		public TypeAndValue getParameterValue() {
		...
		public int decode(InputStream is, boolean withTag) throws IOException {
			...
			if (berTag.equals(TypeAndValue.tag)) {
				parameterValue = new TypeAndValue();
