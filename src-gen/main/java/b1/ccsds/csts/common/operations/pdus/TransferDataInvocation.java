...
public class TransferDataInvocation implements BerType, Serializable {
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += transferDataInvocationExtension.encode(reverseOS);
		
		codeLength += data.encode(reverseOS);
		
		codeLength += sequenceCounter.encode(reverseOS, true);
		
		codeLength += generationTime.encode(reverseOS);
