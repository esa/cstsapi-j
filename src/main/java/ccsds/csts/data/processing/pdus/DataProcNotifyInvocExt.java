...
public class DataProcNotifyInvocExt implements Serializable {

	private static final long serialVersionUID = 1L;

	public static class DataUnitIdLastProcessed implements Serializable {

		private static final long serialVersionUID = 1L;

		public byte[] code = null;
		public static class DataUnitLastProcessed implements Serializable {

			private static final long serialVersionUID = 1L;

			public static class DataProcessingStatus implements Serializable {
				...
				public int encode(BerByteArrayOutputStream os) throws IOException {
					...
					if (dataProcessingStatusExtension != null) {
						codeLength += dataProcessingStatusExtension.encode(os, false);
					...
					if (processingStarted != null) {
						sublength = processingStarted.encode(os);
					...
					if (processingInterrupted != null) {
						sublength = processingInterrupted.encode(os);
						codeLength += sublength;
						codeLength += BerLength.encodeLength(os, sublength);
					...
					if (successfullyProcessed != null) {
						sublength = successfullyProcessed.encode(os);
						codeLength += sublength;
						codeLength += BerLength.encodeLength(os, sublength);
			...
			public int encode(BerByteArrayOutputStream os, boolean withTag) throws IOException {
				...
				int codeLength = 0;
				codeLength += dataProcessingStatus.encode(os);
				
				codeLength += dataUnitId.encode(os, true);
		...
		public int encode(BerByteArrayOutputStream os) throws IOException {
			...
			if (dataUnitLastProcessed != null) {
				codeLength += dataUnitLastProcessed.encode(os, false);
				// write tag: CONTEXT_CLASS, CONSTRUCTED, 1
				os.write(0xA1);
				codeLength += 1;
				return codeLength;
			...
			if (noDataProcessed != null) {
				codeLength += noDataProcessed.encode(os, false);
	...
	public static class DataUnitIdLastOk implements Serializable {

		private static final long serialVersionUID = 1L;

		public byte[] code = null;
		public static class DataUnitId implements Serializable {
			...
			public byte[] code = null;
			private ccsds.csts.common.types.DataUnitId dataUnitId = null;
			...
			public void setDataUnitId(ccsds.csts.common.types.DataUnitId dataUnitId) {
				this.dataUnitId = dataUnitId;
			}

			public ccsds.csts.common.types.DataUnitId getDataUnitId() {
				return dataUnitId;
			}
			...
			public int encode(BerByteArrayOutputStream os, boolean withTag) throws IOException {
				...
				int codeLength = 0;
				codeLength += dataProcessingStopTime.encode(os);
			...
			public int decode(InputStream is, boolean withTag) throws IOException {
				...
				subCodeLength += berTag.decode(is);
				if (berTag.equals(ccsds.csts.common.types.DataUnitId.tag)) {
					dataUnitId = new ccsds.csts.common.types.DataUnitId();
					subCodeLength += dataUnitId.decode(is, false);
					subCodeLength += berTag.decode(is);
				}
				else {
		...
		public int encode(BerByteArrayOutputStream os) throws IOException {
			...
			int codeLength = 0;
			if (dataUnitId != null) {
				codeLength += dataUnitId.encode(os, false);
				// write tag: CONTEXT_CLASS, CONSTRUCTED, 1
				os.write(0xA1);
				codeLength += 1;
				return codeLength;
			...
			if (noSuccessfulProcessing != null) {
				codeLength += noSuccessfulProcessing.encode(os, false);
				// write tag: CONTEXT_CLASS, PRIMITIVE, 0
				os.write(0x80);
				codeLength += 1;
				return codeLength;
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 1)) {
				dataUnitId = new DataUnitId();
				codeLength += dataUnitId.decode(is, false);
				return codeLength;
			}
		...
		public void appendAsString(StringBuilder sb, int indentLevel) {
			...
			if (dataUnitId != null) {
				sb.append("dataUnitId: ");
				dataUnitId.appendAsString(sb, indentLevel + 1);
				return;
			}
	...
	public static class ProductionStatus implements Serializable {

		private static final long serialVersionUID = 1L;

		public byte[] code = null;
		private BerNull productionStatusChange = null;
		private ccsds.csts.common.types.ProductionStatus anyOtherEvent = null;
		...
		public void setAnyOtherEvent(ccsds.csts.common.types.ProductionStatus anyOtherEvent) {
			this.anyOtherEvent = anyOtherEvent;
		}

		public ccsds.csts.common.types.ProductionStatus getAnyOtherEvent() {
		...
		public int encode(BerByteArrayOutputStream os) throws IOException {
			...
			if (anyOtherEvent != null) {
				codeLength += anyOtherEvent.encode(os, false);
				// write tag: CONTEXT_CLASS, CONSTRUCTED, 1
				os.write(0xA1);
				codeLength += 1;
				return codeLength;
			...
			if (productionStatusChange != null) {
				codeLength += productionStatusChange.encode(os, false);
				// write tag: CONTEXT_CLASS, PRIMITIVE, 0
				os.write(0x80);
				codeLength += 1;
				return codeLength;
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 1)) {
				anyOtherEvent = new ccsds.csts.common.types.ProductionStatus();
		...
		public void appendAsString(StringBuilder sb, int indentLevel) {
			...
			if (anyOtherEvent != null) {
				sb.append("anyOtherEvent: ");
				anyOtherEvent.appendAsString(sb, indentLevel + 1);
				return;
			}
	...
	public int encode(BerByteArrayOutputStream os, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += dataProcNotifyInvocExtExtension.encode(os);
		
		codeLength += productionStatus.encode(os);
		
		codeLength += dataUnitIdLastOk.encode(os);
		
		codeLength += dataUnitIdLastProcessed.encode(os);
