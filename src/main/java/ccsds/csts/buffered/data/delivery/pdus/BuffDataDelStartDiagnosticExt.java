...
public class BuffDataDelStartDiagnosticExt implements Serializable {
	...
	public int encode(BerByteArrayOutputStream os) throws IOException {
		...
		if (buffDataDelStartDiagnosticExtExtension != null) {
			codeLength += buffDataDelStartDiagnosticExtExtension.encode(os, false);
		...
		if (inconsistentTime != null) {
			codeLength += inconsistentTime.encode(os, false);
		...
		if (invalidStopGenerationTime != null) {
			codeLength += invalidStopGenerationTime.encode(os, false);
		...
		if (invalidStartGenerationTime != null) {
			codeLength += invalidStartGenerationTime.encode(os, false);
		...
		if (missingTimeValue != null) {
			codeLength += missingTimeValue.encode(os, false);
