...
public class QualifiedValues implements Serializable {
	...
	public int encode(BerByteArrayOutputStream os) throws IOException {
		...
		if (error != null) {
			codeLength += error.encode(os, false);
		...
		if (undefined != null) {
			codeLength += undefined.encode(os, false);
		...
		if (unavailable != null) {
			codeLength += unavailable.encode(os, false);
