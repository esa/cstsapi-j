...
public class ProcedureInstanceId implements Serializable {

	private static final long serialVersionUID = 1L;

	public static class ProcedureRole implements Serializable {
		...
		public int encode(BerByteArrayOutputStream os) throws IOException {
			...
			if (associationControl != null) {
				codeLength += associationControl.encode(os, false);
			...
			if (secondaryProcedure != null) {
				codeLength += secondaryProcedure.encode(os, false);
			...
			if (primeProcedure != null) {
				codeLength += primeProcedure.encode(os, false);
	...
	public ProcedureInstanceId() {
	}

	public ProcedureInstanceId(byte[] code) {
		this.code = code;
	}
	...
	public int encode(BerByteArrayOutputStream os, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += procedureRole.encode(os);
		
		codeLength += procedureType.encode(os, true);
