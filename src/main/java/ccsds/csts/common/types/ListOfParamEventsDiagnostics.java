...
public class ListOfParamEventsDiagnostics implements Serializable {

	private static final long serialVersionUID = 1L;

	public byte[] code = null;
	public static class UnknownParamEventIdentifier implements Serializable {
		...
		public static class CHOICE implements Serializable {
			...
			public int encode(BerByteArrayOutputStream os) throws IOException {
				...
				if (paramEventName != null) {
					codeLength += paramEventName.encode(os, false);
				...
				if (paramEventLabel != null) {
					codeLength += paramEventLabel.encode(os, false);
	...
	public int encode(BerByteArrayOutputStream os) throws IOException {
		...
		if (unknownParamEventIdentifier != null) {
			codeLength += unknownParamEventIdentifier.encode(os, false);
		...
		if (unknownProcedureInstanceId != null) {
			codeLength += unknownProcedureInstanceId.encode(os, false);
		...
		if (unknownProcedureType != null) {
			codeLength += unknownProcedureType.encode(os, false);
		...
		if (unknownFunctionalResourceName != null) {
			codeLength += unknownFunctionalResourceName.encode(os, false);
			// write tag: CONTEXT_CLASS, CONSTRUCTED, 1
			os.write(0xA1);
			codeLength += 1;
			return codeLength;
		...
		if (unknownFunctionalResourceType != null) {
			codeLength += unknownFunctionalResourceType.encode(os, false);
		...
		if (unknownListName != null) {
			codeLength += unknownListName.encode(os, false);
		...
		if (undefinedDefault != null) {
			codeLength += undefinedDefault.encode(os, false);
