...
public class StandardReturnHeader implements Serializable {
	...
	public static class Result implements Serializable {
		...
		public static class Negative implements Serializable {
			...
			public int encode(BerByteArrayOutputStream os, boolean withTag) throws IOException {
				...
				int codeLength = 0;
				codeLength += negExtension.encode(os);
				
				codeLength += diagnostic.encode(os);
		...
		public int encode(BerByteArrayOutputStream os) throws IOException {
			...
			if (negative != null) {
				codeLength += negative.encode(os, false);
	...
	public int encode(BerByteArrayOutputStream os, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += result.encode(os);
		
		codeLength += invokeId.encode(os, true);
		
		codeLength += performerCredentials.encode(os);
