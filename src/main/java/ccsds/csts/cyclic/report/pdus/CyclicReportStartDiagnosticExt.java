...
public class CyclicReportStartDiagnosticExt implements Serializable {
	...
	public int encode(BerByteArrayOutputStream os) throws IOException {
		...
		if (cyclicReportStartDiagnosticExtExtension != null) {
			codeLength += cyclicReportStartDiagnosticExtExtension.encode(os, false);
		...
		if (outOfRange != null) {
			codeLength += outOfRange.encode(os, false);
