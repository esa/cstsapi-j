...
public class SequContrDataProcProcDataInvocExt implements Serializable {
	...
	public int encode(BerByteArrayOutputStream os, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += sequContrDataProcDataInvocExtExtension.encode(os);
		
		codeLength += latestDataProcessingTime.encode(os);
		
		codeLength += earliestDataProcessingTime.encode(os);
