...
public class SequContrDataProcProcDataDiagnosticExt implements Serializable {
	...
	public int encode(BerByteArrayOutputStream os) throws IOException {
		...
		if (sequContrDataProcProcDataDiagnosticExtExtension != null) {
			codeLength += sequContrDataProcProcDataDiagnosticExtExtension.encode(os, false);
		...
		if (unableToStore != null) {
			codeLength += unableToStore.encode(os, false);
		...
		if (dataError != null) {
			codeLength += dataError.encode(os, false);
		...
		if (lateData != null) {
			codeLength += lateData.encode(os, false);
		...
		if (invalidTime != null) {
			codeLength += invalidTime.encode(os, false);
		...
		if (inconsistentTimeRange != null) {
			codeLength += inconsistentTimeRange.encode(os, false);
		...
		if (outOfSequence != null) {
			codeLength += outOfSequence.encode(os, false);
		...
		if (serviceInstanceLocked != null) {
			codeLength += serviceInstanceLocked.encode(os, false);
		...
		if (unableToProcess != null) {
			codeLength += unableToProcess.encode(os, false);
