...
public class SequContrDataProcStartInvocExt implements Serializable {
	...
	public int encode(BerByteArrayOutputStream os, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += sequContrDataProcStartInvocExtExtension.encode(os);
		
		codeLength += firstDataUnitId.encode(os, true);
