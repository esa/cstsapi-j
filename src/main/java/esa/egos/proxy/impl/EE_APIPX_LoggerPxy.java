...
public class EE_APIPX_LoggerPxy extends EE_APIPX_LinkAdapter implements IDefaultLogger, IReporter
{
    ...
    @Override
    public void logRecord(IServiceInstanceIdentifier sii, ProcedureInstanceIdentifier procedureIdentifier, Component component, AlarmLevel alarm, CstsLogMessageType type, String message)    {
