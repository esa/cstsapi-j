...
public class NotificationCodecB1 {
	...
	public static EmbeddedData encodeInvocationExtension(AbstractNotification notification) {
		...
		invocationExtension.setListOfEvents(notification.getListOfEvents().encode(new b1.ccsds.csts.common.types.ListOfParametersEvents()));
	...
	public static EmbeddedData encodeStartDiagnosticExt(AbstractNotification notification) {
		...
		if (notification.getListOfEventsDiagnostics() != null) {
			diagnosticExtension.setCommon(notification.getListOfEventsDiagnostics().encode(
					new b1.ccsds.csts.common.types.ListOfParamEventsDiagnostics()));
		}
