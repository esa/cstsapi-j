...
public class BufferedDataDeliveryCodecB2 {
	...
	public static byte[] encodeOperation(AbstractBufferedDataDelivery bufferedDataDelivery,IOperation operation, boolean isInvoke) throws IOException {
		b2.ccsds.csts.buffered.data.delivery.pdus.BufferedDataDeliveryPdu pdu = 
				new b2.ccsds.csts.buffered.data.delivery.pdus.BufferedDataDeliveryPdu();
	...
	public static EmbeddedData encodeInvocationExtension(AbstractBufferedDataDelivery bufferedDataDelivery) {
		...
		b2.ccsds.csts.buffered.data.delivery.pdus.BuffDataDelStartInvocExt invocationExtension = 
				new b2.ccsds.csts.buffered.data.delivery.pdus.BuffDataDelStartInvocExt();

		invocationExtension.setStartGenerationTime(
				bufferedDataDelivery.getStartGenerationTime().encode(new b2.ccsds.csts.common.types.ConditionalTime()));
		invocationExtension.setStopGenerationTime(
				bufferedDataDelivery.getStopGenerationTime().encode(new b2.ccsds.csts.common.types.ConditionalTime()));
	...
	public static void decodeStartDiagnosticExt(AbstractBufferedDataDelivery bufferedDataDelivery,EmbeddedData diagnosticExtension) {
		 b2.ccsds.csts.buffered.data.delivery.pdus.BuffDataDelStartDiagnosticExt  buffDataDelStartDiagnosticExt = 
				 new  b2.ccsds.csts.buffered.data.delivery.pdus.BuffDataDelStartDiagnosticExt();
	...
	public static EmbeddedData encodeStartDiagnosticExt(AbstractBufferedDataDelivery bufferedDataDelivery) {
		return EmbeddedData.of(OIDs.bddStartDiagExt, bufferedDataDelivery.getStartDiagnostic().encode(
				new b2.ccsds.csts.buffered.data.delivery.pdus.BuffDataDelStartDiagnosticExt()).code);
