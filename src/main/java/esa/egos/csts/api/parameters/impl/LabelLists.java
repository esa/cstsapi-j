 ...
 * 
 * Label Lists are already set to configured. However, the Service using this
...
public class LabelLists extends AbstractConfigurationParameter implements Observer {
	 ...
	 * @throws ConfigurationParameterNotModifiableException
	 *             if this Configuration Parameter is not dynamically modifiable
	 */
	public boolean add(LabelList list) {
	 ...
	 *             if this Configuration Parameter is not dynamically modifiable
	 */
	public boolean remove(LabelList list) {
		if (!isDynamicallyModifiable()) {
			throw new ConfigurationParameterNotModifiableException();
		}
