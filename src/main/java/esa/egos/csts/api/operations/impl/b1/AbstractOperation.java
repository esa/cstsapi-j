...
public abstract class AbstractOperation implements IOperation {
	 ...
	 */
	protected final  b1.ccsds.csts.common.types.StandardInvocationHeader encodeStandardInvocationHeader() {

		 b1.ccsds.csts.common.types.StandardInvocationHeader header = 
				 new  b1.ccsds.csts.common.types.StandardInvocationHeader();
		...
		if (getInvokerCredentials() != null) {
			header.setInvokerCredentials(credentials.encode(new b1.ccsds.csts.common.types.Credentials()));
		} else {
			header.setInvokerCredentials(getEmptyCredentials());
		}
		header.setProcedureInstanceId(getProcedureInstanceIdentifier().encode(new b1.ccsds.csts.common.types.ProcedureInstanceId()));
