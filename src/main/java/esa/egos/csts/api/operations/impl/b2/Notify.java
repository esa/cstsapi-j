...
public class Notify extends AbstractOperation implements INotify {
	...
	public NotifyInvocation encodeNotifyInvocation() {
		...
		notifyInvocation.setEventTime(eventTime.encode(new b2.ccsds.csts.common.types.Time()));
		notifyInvocation.setEventName(eventName.encode(new b2.ccsds.csts.common.types.Name()));
		notifyInvocation.setEventValue(eventValue.encode(new b2.ccsds.csts.common.types.EventValue()));
