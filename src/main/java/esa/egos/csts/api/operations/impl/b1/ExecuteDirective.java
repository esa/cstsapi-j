...
public class ExecuteDirective extends AbstractAcknowledgedOperation implements IExecuteDirective {
	...
	public ExecuteDirectiveInvocation encodeExecuteDirectiveInvocation() {
		...
		invocation.setDirectiveQualifier(directiveQualifier.encode(new b1.ccsds.csts.common.operations.pdus.ExecuteDirectiveInvocation.DirectiveQualifier()));
		invocation.setExecuteDirectiveInvocationExtension(invocationExtension.encode(new b1.ccsds.csts.common.types.Extended()));
		return invocation;
	}
	...
	private EmbeddedData encodeExecDirAcknowledgementDiagnostic() {
		return EmbeddedData.of(OIDs.execDirAckDiagExt, execDirAcknowledgementDiagnostic.encode(new b1.ccsds.csts.common.operations.pdus.ExecDirNegAckDiagnosticExt()).code);
	}
	
	private EmbeddedData encodeExecDirReturnDiagnostic() {
		return EmbeddedData.of(OIDs.execDirNegReturnDiagnosticExt, execDirReturnDiagnostic.encode(new b1.ccsds.csts.common.operations.pdus.ExecDirNegReturnDiagnosticExt()).code);
	}
