...
public class Header_Mess extends Message
{
    private static final Logger LOG = Logger.getLogger(Header_Mess.class.getName());
    ...
    public Header_Mess(boolean lastPdu, int mid, int length)
    {
    ...
    public String toString()
    {
        return "PXCS_Header Message [lastPdu = " + this.lastPdu + ", mid = "
               + MessId.getPXCSMessIdByCode(this.mid) + ", length = " + this.length + "]";
    }
}
