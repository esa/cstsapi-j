...
public class RegisterMess extends Message
{
    private static final Logger LOG = Logger.getLogger(RegisterMess.class.getName());
    ...
    public RegisterMess(boolean initialFormatUsed, int regId, String sii, String portname)
    {
