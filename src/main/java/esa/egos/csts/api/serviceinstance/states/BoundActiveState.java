...
public class BoundActiveState implements IServiceInstanceState {

	private String stateName = "bound";
	private String stateDescription = "";
	private ServiceInstanceStateEnum state = ServiceInstanceStateEnum.bound;
	
	private String subStateName = "active";
	private String subStateDescription = "";
	private ServiceInstanceStateEnum subState = ServiceInstanceStateEnum.active;
