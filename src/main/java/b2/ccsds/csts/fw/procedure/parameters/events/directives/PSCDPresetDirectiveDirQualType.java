...
public class PSCDPresetDirectiveDirQualType extends PSCDPdataUnitId {

	private static final long serialVersionUID = 1L;

	public PSCDPresetDirectiveDirQualType() {
	}

	public PSCDPresetDirectiveDirQualType(byte[] code) {
		super(code);
	}

	public PSCDPresetDirectiveDirQualType(BigInteger value) {
		super(value);
	}

	public PSCDPresetDirectiveDirQualType(long value) {
		super(value);
	}
