...
public class PBDPproductionStatusChangeEvtValueType extends SvcProductionStatusVersion1Type {

	private static final long serialVersionUID = 1L;

	public PBDPproductionStatusChangeEvtValueType() {
	}

	public PBDPproductionStatusChangeEvtValueType(byte[] code) {
		super(code);
	}

	public PBDPproductionStatusChangeEvtValueType(BigInteger value) {
		super(value);
	}

	public PBDPproductionStatusChangeEvtValueType(long value) {
		super(value);
	}
