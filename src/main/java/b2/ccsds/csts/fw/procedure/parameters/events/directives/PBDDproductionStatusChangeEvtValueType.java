...
public class PBDDproductionStatusChangeEvtValueType extends SvcProductionStatusVersion1Type {

	private static final long serialVersionUID = 1L;

	public PBDDproductionStatusChangeEvtValueType() {
	}

	public PBDDproductionStatusChangeEvtValueType(byte[] code) {
		super(code);
	}

	public PBDDproductionStatusChangeEvtValueType(BigInteger value) {
		super(value);
	}

	public PBDDproductionStatusChangeEvtValueType(long value) {
		super(value);
	}
