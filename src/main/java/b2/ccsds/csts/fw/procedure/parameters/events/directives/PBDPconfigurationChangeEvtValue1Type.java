...
public class PBDPconfigurationChangeEvtValue1Type extends PBDPmaxForwardBufferSizeType {

	private static final long serialVersionUID = 1L;

	public PBDPconfigurationChangeEvtValue1Type() {
	}

	public PBDPconfigurationChangeEvtValue1Type(byte[] code) {
		super(code);
	}

	public PBDPconfigurationChangeEvtValue1Type(BigInteger value) {
		super(value);
	}

	public PBDPconfigurationChangeEvtValue1Type(long value) {
		super(value);
	}
