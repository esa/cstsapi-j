...
public class PBDPconfigurationChangeEvtValue2Type extends PDPinputQueueSizeType {

	private static final long serialVersionUID = 1L;

	public PBDPconfigurationChangeEvtValue2Type() {
	}

	public PBDPconfigurationChangeEvtValue2Type(byte[] code) {
		super(code);
	}

	public PBDPconfigurationChangeEvtValue2Type(BigInteger value) {
		super(value);
	}

	public PBDPconfigurationChangeEvtValue2Type(long value) {
		super(value);
	}
