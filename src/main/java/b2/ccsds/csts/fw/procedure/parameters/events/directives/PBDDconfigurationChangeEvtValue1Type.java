...
public class PBDDconfigurationChangeEvtValue1Type extends PBDDreturnBufferSizeType {

	private static final long serialVersionUID = 1L;

	public PBDDconfigurationChangeEvtValue1Type() {
	}

	public PBDDconfigurationChangeEvtValue1Type(byte[] code) {
		super(code);
	}

	public PBDDconfigurationChangeEvtValue1Type(BigInteger value) {
		super(value);
	}

	public PBDDconfigurationChangeEvtValue1Type(long value) {
		super(value);
	}
