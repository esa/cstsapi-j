...
public class PDPconfigurationChangeEvtValueType extends PDPinputQueueSizeType {

	private static final long serialVersionUID = 1L;

	public PDPconfigurationChangeEvtValueType() {
	}

	public PDPconfigurationChangeEvtValueType(byte[] code) {
		super(code);
	}

	public PDPconfigurationChangeEvtValueType(BigInteger value) {
		super(value);
	}

	public PDPconfigurationChangeEvtValueType(long value) {
		super(value);
	}
