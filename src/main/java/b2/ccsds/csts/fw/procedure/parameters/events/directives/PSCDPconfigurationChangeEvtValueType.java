...
public class PSCDPconfigurationChangeEvtValueType extends PDPinputQueueSizeType {

	private static final long serialVersionUID = 1L;

	public PSCDPconfigurationChangeEvtValueType() {
	}

	public PSCDPconfigurationChangeEvtValueType(byte[] code) {
		super(code);
	}

	public PSCDPconfigurationChangeEvtValueType(BigInteger value) {
		super(value);
	}

	public PSCDPconfigurationChangeEvtValueType(long value) {
		super(value);
	}
