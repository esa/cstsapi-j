...
public class StopInvocation implements BerType, Serializable {
	...
	private Extended stopInvocationExtension = null;
	
	public StopInvocation() {
	}

	public StopInvocation(byte[] code) {
		this.code = code;
	}
	...
	public void setStopInvocationExtension(Extended stopInvocationExtension) {
		this.stopInvocationExtension = stopInvocationExtension;
	}

	public Extended getStopInvocationExtension() {
		return stopInvocationExtension;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += stopInvocationExtension.encode(reverseOS);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		stopInvocationExtension = new Extended();
		subCodeLength += stopInvocationExtension.decode(is, berTag);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (stopInvocationExtension != null) {
			sb.append("stopInvocationExtension: ");
			stopInvocationExtension.appendAsString(sb, indentLevel + 1);
		}
		else {
			sb.append("stopInvocationExtension: <empty-required-field>");
		}
