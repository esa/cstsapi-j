...
public class StartInvocation implements BerType, Serializable {
	...
	private Extended startInvocationExtension = null;
	
	public StartInvocation() {
	}

	public StartInvocation(byte[] code) {
		this.code = code;
	}
	...
	public void setStartInvocationExtension(Extended startInvocationExtension) {
		this.startInvocationExtension = startInvocationExtension;
	}

	public Extended getStartInvocationExtension() {
		return startInvocationExtension;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += startInvocationExtension.encode(reverseOS);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		startInvocationExtension = new Extended();
		subCodeLength += startInvocationExtension.decode(is, berTag);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (startInvocationExtension != null) {
			sb.append("startInvocationExtension: ");
			startInvocationExtension.appendAsString(sb, indentLevel + 1);
		}
		else {
			sb.append("startInvocationExtension: <empty-required-field>");
		}
