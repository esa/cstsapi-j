...
public class ISP1Credentials implements Serializable {
	...
	public int encode(BerByteArrayOutputStream os, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += theProtected.encode(os, true);
		
		codeLength += randomNumber.encode(os, true);
