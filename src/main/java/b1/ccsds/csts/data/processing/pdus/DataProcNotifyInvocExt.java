...
public class DataProcNotifyInvocExt implements BerType, Serializable {
	...
	public static class DataUnitIdLastOk implements BerType, Serializable {
		...
		public byte[] code = null;
		public static class DataUnitId implements BerType, Serializable {
			...
			public byte[] code = null;
			private b1.ccsds.csts.common.types.DataUnitId dataUnitId = null;
			...
			public void setDataUnitId(b1.ccsds.csts.common.types.DataUnitId dataUnitId) {
				this.dataUnitId = dataUnitId;
			}

			public b1.ccsds.csts.common.types.DataUnitId getDataUnitId() {
				return dataUnitId;
			}
			...
			public int decode(InputStream is, boolean withTag) throws IOException {
				...
				subCodeLength += berTag.decode(is);
				if (berTag.equals(b1.ccsds.csts.common.types.DataUnitId.tag)) {
					dataUnitId = new b1.ccsds.csts.common.types.DataUnitId();
					subCodeLength += dataUnitId.decode(is, false);
					subCodeLength += berTag.decode(is);
				}
				else {
		...
		public int encode(OutputStream reverseOS) throws IOException {
			...
			int codeLength = 0;
			if (dataUnitId != null) {
				codeLength += dataUnitId.encode(reverseOS, false);
				// write tag: CONTEXT_CLASS, CONSTRUCTED, 1
				reverseOS.write(0xA1);
				codeLength += 1;
				return codeLength;
	...
	public static class ProductionStatus implements BerType, Serializable {
		...
		private b1.ccsds.csts.common.types.ProductionStatus anyOtherEvent = null;
		...
		public void setAnyOtherEvent(b1.ccsds.csts.common.types.ProductionStatus anyOtherEvent) {
			this.anyOtherEvent = anyOtherEvent;
		}

		public b1.ccsds.csts.common.types.ProductionStatus getAnyOtherEvent() {
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 1)) {
				anyOtherEvent = new b1.ccsds.csts.common.types.ProductionStatus();
