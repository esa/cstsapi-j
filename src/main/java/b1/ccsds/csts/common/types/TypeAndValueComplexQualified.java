...
public class TypeAndValueComplexQualified implements BerType, Serializable {

	private static final long serialVersionUID = 1L;

	public byte[] code = null;
	public static class ComplexSequence implements BerType, Serializable {
	...
	public static class ComplexSet implements BerType, Serializable {
	...
	public int encode(OutputStream reverseOS) throws IOException {
		...
		if (complexSet != null) {
			codeLength += complexSet.encode(reverseOS, false);
		...
		if (complexSequence != null) {
			codeLength += complexSequence.encode(reverseOS, false);
		...
		if (typeAndValue != null) {
			sublength = typeAndValue.encode(reverseOS);
