...
public class FwdTcVcMuxAdFrameRepetitions implements BerType, Serializable {
	...
	public static class SEQUENCE implements BerType, Serializable {
		...
		private BerInteger repetitions = null;
		...
		public void setRepetitions(BerInteger repetitions) {
			this.repetitions = repetitions;
		}

		public BerInteger getRepetitions() {
			return repetitions;
		}
		...
		public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
			...
			int codeLength = 0;
			codeLength += repetitions.encode(reverseOS, true);
		...
		public int decode(InputStream is, boolean withTag) throws IOException {
			...
			if (berTag.equals(BerInteger.tag)) {
				repetitions = new BerInteger();
				subCodeLength += repetitions.decode(is, false);
		...
		public void appendAsString(StringBuilder sb, int indentLevel) {
			...
			if (repetitions != null) {
				...
				sb.append("repetitions: <empty-required-field>");
			}
	...
	public FwdTcVcMuxAdFrameRepetitions() {
		seqOf = new ArrayList<SEQUENCE>();
	}

	public FwdTcVcMuxAdFrameRepetitions(byte[] code) {
		this.code = code;
	}
