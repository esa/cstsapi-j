...
public class TmAosVcDemuxGvcid implements BerType, Serializable {

	private static final long serialVersionUID = 1L;

	public byte[] code = null;
	public static class TmGvcid implements BerType, Serializable {
	...
	private TmGvcid tmGvcid = null;
	private AosGvcid aosGvcid = null;
	
	public TmAosVcDemuxGvcid() {
	}

	public TmAosVcDemuxGvcid(byte[] code) {
		this.code = code;
	}

	public void setTmGvcid(TmGvcid tmGvcid) {
		this.tmGvcid = tmGvcid;
	}

	public TmGvcid getTmGvcid() {
		return tmGvcid;
	}
	...
	public int encode(OutputStream reverseOS) throws IOException {
		...
		if (tmGvcid != null) {
			codeLength += tmGvcid.encode(reverseOS, false);
	...
	public int decode(InputStream is, BerTag berTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 0)) {
			tmGvcid = new TmGvcid();
			codeLength += tmGvcid.decode(is, false);
			return codeLength;
		}
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (tmGvcid != null) {
			sb.append("tmGvcid: ");
			tmGvcid.appendAsString(sb, indentLevel + 1);
			return;
		}
