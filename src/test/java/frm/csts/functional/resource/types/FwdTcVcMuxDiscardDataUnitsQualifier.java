...
public class FwdTcVcMuxDiscardDataUnitsQualifier implements BerType, Serializable {
	...
	public FwdTcVcMuxDiscardDataUnitsQualifier() {
	}

	public FwdTcVcMuxDiscardDataUnitsQualifier(byte[] code) {
		this.code = code;
	}
