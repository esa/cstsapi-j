...
public class TdmSegGenRangePathTable implements BerType, Serializable {
	...
	public static class SEQUENCE implements BerType, Serializable {
		...
		private BerEnum rangeUnits = null;
		private ShortIntPos integrationInterval = null;
		...
		public void setRangeUnits(BerEnum rangeUnits) {
			this.rangeUnits = rangeUnits;
		}

		public BerEnum getRangeUnits() {
			return rangeUnits;
		}

		public void setIntegrationInterval(ShortIntPos integrationInterval) {
			this.integrationInterval = integrationInterval;
		}

		public ShortIntPos getIntegrationInterval() {
		...
		public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
			...
			codeLength += rangeUnits.encode(reverseOS, true);
		...
		public int decode(InputStream is, boolean withTag) throws IOException {
			...
			if (berTag.equals(BerEnum.tag)) {
				rangeUnits = new BerEnum();
				subCodeLength += rangeUnits.decode(is, false);
				subCodeLength += berTag.decode(is);
			}
			else {
				throw new IOException("Tag does not match the mandatory sequence element tag.");
			...
			if (berTag.equals(ShortIntPos.tag)) {
				integrationInterval = new ShortIntPos();
		...
		public void appendAsString(StringBuilder sb, int indentLevel) {
			...
			if (threeWayRcvAperture != null) {
				...
				sb.append("threeWayRcvAperture: <empty-required-field>");
			}
			...
			if (xmitFreqBand != null) {
				...
				sb.append("xmitFreqBand: <empty-required-field>");
			}
			...
			if (rangeUnits != null) {
				sb.append("rangeUnits: ").append(rangeUnits);
			}
			else {
				sb.append("rangeUnits: <empty-required-field>");
			}
	...
	public TdmSegGenRangePathTable() {
		seqOf = new ArrayList<SEQUENCE>();
	}

	public TdmSegGenRangePathTable(byte[] code) {
		this.code = code;
	}
