...
public class CfdpReportIndication implements BerType, Serializable {
	...
	public CfdpReportIndication() {
	}

	public CfdpReportIndication(byte[] code) {
		this.code = code;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += statusReport.encode(reverseOS, true);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (statusReport != null) {
			...
			sb.append("statusReport: <empty-required-field>");
		}
