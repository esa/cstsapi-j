...
public class RocfPermittedContrWordTypeSet implements BerType, Serializable {
	...
	public RocfPermittedContrWordTypeSet() {
		seqOf = new ArrayList<BerEnum>();
	}

	public RocfPermittedContrWordTypeSet(byte[] code) {
		this.code = code;
	}
