...
public class FlfSyncDecodeQualityIndications implements BerType, Serializable {
	...
	public FlfSyncDecodeQualityIndications() {
	}

	public FlfSyncDecodeQualityIndications(byte[] code) {
		this.code = code;
	}
