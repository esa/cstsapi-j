...
public class FlfSyncDecode implements BerType, Serializable {
	...
	public static class SymbolDecode implements BerType, Serializable {
		...
		private LdpcCodeRate ldpc = null;
		...
		public void setLdpc(LdpcCodeRate ldpc) {
			this.ldpc = ldpc;
		}

		public LdpcCodeRate getLdpc() {
			return ldpc;
		}
	...
	public FlfSyncDecode() {
	}

	public FlfSyncDecode(byte[] code) {
		this.code = code;
	}
