...
public class RocfPermittedControlWordTypeSet implements BerType, Serializable {
	...
	public RocfPermittedControlWordTypeSet() {
		seqOf = new ArrayList<BerEnum>();
	}

	public RocfPermittedControlWordTypeSet(byte[] code) {
		this.code = code;
	}
