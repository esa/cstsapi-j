...
public class FwdTcMcMuxDiscardDataUnitsQualifier implements BerType, Serializable {
	...
	public FwdTcMcMuxDiscardDataUnitsQualifier() {
	}

	public FwdTcMcMuxDiscardDataUnitsQualifier(byte[] code) {
		this.code = code;
	}
