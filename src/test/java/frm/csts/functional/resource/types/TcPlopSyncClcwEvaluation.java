...
public class TcPlopSyncClcwEvaluation implements BerType, Serializable {
	...
	public static class Evaluation implements BerType, Serializable {
		...
		public static class ClcwSource implements BerType, Serializable {
			...
			public static class Tfvn4 implements BerType, Serializable {
			...
			public void setTfvn4(Tfvn4 tfvn4) {
				this.tfvn4 = tfvn4;
			}

			public Tfvn4 getTfvn4() {
				return tfvn4;
			}
			...
			public int encode(OutputStream reverseOS) throws IOException {
				...
				int codeLength = 0;
				if (tfvn4 != null) {
					codeLength += tfvn4.encode(reverseOS, false);
			...
			public int decode(InputStream is, BerTag berTag) throws IOException {
				...
				if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 2)) {
					tfvn4 = new Tfvn4();
					codeLength += tfvn4.decode(is, false);
					return codeLength;
				}
			...
			public void appendAsString(StringBuilder sb, int indentLevel) {
				...
				if (tfvn4 != null) {
					sb.append("tfvn4: ");
					tfvn4.appendAsString(sb, indentLevel + 1);
					return;
				}
	...
	public TcPlopSyncClcwEvaluation() {
	}

	public TcPlopSyncClcwEvaluation(byte[] code) {
		this.code = code;
	}
