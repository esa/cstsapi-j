...
public class Ccsds401CarrierRcptPolarization implements BerType, Serializable {
	...
	public Ccsds401CarrierRcptPolarization() {
	}

	public Ccsds401CarrierRcptPolarization(byte[] code) {
		this.code = code;
	}
