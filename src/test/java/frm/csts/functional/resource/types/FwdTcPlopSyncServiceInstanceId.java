...
public class FwdTcPlopSyncServiceInstanceId implements BerType, Serializable {
	...
	public FwdTcPlopSyncServiceInstanceId() {
	}

	public FwdTcPlopSyncServiceInstanceId(byte[] code) {
		this.code = code;
	}
