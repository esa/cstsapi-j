...
public class AntTrackingSignalPolarization implements BerType, Serializable {
	...
	private BerInteger combining = null;
	
	public AntTrackingSignalPolarization() {
	}

	public AntTrackingSignalPolarization(byte[] code) {
		this.code = code;
	}
	...
	public void setCombining(BerInteger combining) {
		this.combining = combining;
	}

	public BerInteger getCombining() {
		return combining;
	}
	...
	public int encode(OutputStream reverseOS) throws IOException {
		...
		int codeLength = 0;
		if (combining != null) {
			codeLength += combining.encode(reverseOS, false);
	...
	public int decode(InputStream is, BerTag berTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 3)) {
			combining = new BerInteger();
			codeLength += combining.decode(is, false);
			return codeLength;
		}
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (combining != null) {
			sb.append("combining: ").append(combining);
			return;
		}
