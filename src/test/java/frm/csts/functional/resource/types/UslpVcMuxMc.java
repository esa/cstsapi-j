...
public class UslpVcMuxMc implements BerType, Serializable {
	...
	private BerBitString tfvn = null;
	private BerInteger scid = null;
	
	public UslpVcMuxMc() {
	}

	public UslpVcMuxMc(byte[] code) {
		this.code = code;
	}

	public void setTfvn(BerBitString tfvn) {
		this.tfvn = tfvn;
	}

	public BerBitString getTfvn() {
		return tfvn;
	}
