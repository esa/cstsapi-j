...
public class TdmSegGenCarrierPowerPathTable implements BerType, Serializable {
	...
	public TdmSegGenCarrierPowerPathTable() {
		seqOf = new ArrayList<SEQUENCE>();
	}

	public TdmSegGenCarrierPowerPathTable(byte[] code) {
		this.code = code;
	}
