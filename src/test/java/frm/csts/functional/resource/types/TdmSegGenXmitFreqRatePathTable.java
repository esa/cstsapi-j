...
public class TdmSegGenXmitFreqRatePathTable implements BerType, Serializable {
	...
	public TdmSegGenXmitFreqRatePathTable() {
		seqOf = new ArrayList<SEQUENCE>();
	}

	public TdmSegGenXmitFreqRatePathTable(byte[] code) {
		this.code = code;
	}
