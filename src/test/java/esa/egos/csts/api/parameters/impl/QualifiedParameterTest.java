...
public class QualifiedParameterTest {
	...
	public void testEqualsObject() {
		...
		pv.getStringParameterValues().add("CHARACTER_STRING");
		pvList.add(pv);
		...
		pv.getIntegerParameterValues().add(new Long(1));
		pvList.add(pv);
		pv = new ParameterValue(ParameterType.INTEGER);
		pv.getIntegerParameterValues().add(new Long(2));
		pvList.add(pv);
		...
		pv.getIntegerParameterValues().add(new Long(3));
		pvList.add(pv);
		...
		pv.getRealParameterValues().add(new Double(4.0));
		pvList.add(pv);
		...
		pv.getIntegerParameterValues().add(new Long(5));
		pvList.add(pv);
		...
		pv1.getStringParameterValues().add("CHARACTER_STRING");
		pvList1.add(pv1);
		...
		pv1.getIntegerParameterValues().add(new Long(1));
		pvList1.add(pv1);
		pv1 = new ParameterValue(ParameterType.INTEGER);
		pv1.getIntegerParameterValues().add(new Long(2));
		pvList1.add(pv1);
		...
		pv1.getIntegerParameterValues().add(new Long(3));
		pvList1.add(pv1);
		...
		pv1.getRealParameterValues().add(new Double(4.0));
		pvList1.add(pv1);
		...
		pv1.getIntegerParameterValues().add(new Long(5));
		pvList1.add(pv1);
