...
//        testEvents.add(new TestParameter(Fr.RcfTsProvider.event.rcfProdConfigurationChangeEventValueValueOid,
//        		CstsNullValue.of("rcfProdConfigurationChangeEventValue"), CstsNullValue.of("rcfProdConfigurationChangeEventValue")));
