...
public class CyclicReportCfdpEntityTest extends CyclicReportFrTestBase
{
    ...
    public static void setupClass() throws Exception
    {
        ...
        testParameters.add(new TestParameter(Fr.CfdpEntity.parameter.cfdpLocalEntityConfigurationParamOid, 
            ...
            CstsComplexValue.of("cfdpLocalEntityConfiguration",
                CstsIntValue.of("cfdpLocalEofSentIndicationRequired", 100),
                CstsIntValue.of("cfdpLocalRecvIndicationRequired", 100),
                CstsIntValue.of("cfdpLocalFileSegmentRecvdIndicationRequired", 100),
                CstsIntValue.of("cfdpLocalTransactionFinishedIndicationRequired", 100),
                CstsIntValue.of("cfdpLocalSuspendedIndicationRequired", 100),
                CstsIntValue.of("cfdpLocalResumedIndicationRequired", 100),
                CstsIntValue.of("cfdpLocalPositiveAckLimitReachedFaultHandler", 100),
                CstsIntValue.of("cfdpLocalKeepAliveLimitFaultHandler", 100),
                CstsIntValue.of("cfdpLocalInvalidTransmissionModeFaultHandler", 100),
                CstsIntValue.of("cfdpLocalFilestoreRejectionFaultHandler", 100),
                CstsIntValue.of("cfdpLocalFileChecksumFailureFaultHandler", 100),
                CstsIntValue.of("cfdpLocalFileSizeErrorFaultHandler", 100),
                CstsIntValue.of("cfdpLocalNakLimitReachedFaultHandler", 100),
                CstsIntValue.of("cfdpLocalInactivityDetectedFaultHandler", 100),
                CstsIntValue.of("cfdpLocalInvalidFileStructureFaultHandler", 100),
                CstsIntValue.of("cfdpLocalCheckLimitReachedFaultHandler", 100),
                CstsComplexValue.of("cfdpLocalRoutingInformation", 
                    CstsIntValue.of("seqOf",120),
                    CstsIntValue.of("seqOf",140)
                )
            )
        ));
