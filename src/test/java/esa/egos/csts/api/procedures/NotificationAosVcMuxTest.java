...
/**
 * Test CSTS API notification procedure w/ FR AosVcMux events
 */
public class NotificationAosVcMuxTest extends NotificationFrTestBase
{
    ...
    public static void setupClass() throws Exception
    {
        ...
        testEvents.add(new TestParameter(Fr.AosVcMux.event.aosVcMuxDataUnitProcessingCompletedValueValueOid, 
        		CstsComplexValue.of("aosVcMuxDataUnitProcessingCompletedValue",
        ...
        testEvents.add(new TestParameter(Fr.AosVcMux.event.aosVcMuxResourceStatValueValueOid, "aosVcMuxResourceStatValue", 0, 1));
